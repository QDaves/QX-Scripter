...
public class HeaderRecord : FlashItem
{
    ...
    public ushort? SourceHeaderWord { get; }
    public bool? SourceIsLongTag =>
        SourceHeaderWord.HasValue
            ? (SourceHeaderWord.Value & 63) == 63
            : null;
    public int? SourceHeaderLength =>
        SourceIsLongTag.HasValue
            ? SourceIsLongTag.Value ? 6 : 2
            : null;
